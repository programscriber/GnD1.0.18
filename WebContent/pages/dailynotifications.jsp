			...
			<div class="left-content">
				<div class="demo-left-nav" id="left-nav">
					<div class="navigation">
						<ul>
									<li ><a href="/GnD/emailcont/email">Email
									</a></li>
									<li class="selected"><a href="/GnD/emailcont/dailyEmail">DailyNotifications
									</a></li>
						</ul>
					</div>
				</div>
...
<div class="right-content record">
                    ...
                    <c:if test="${success eq 'true'}">
							<div class="errorblock">
								Your mail has been saved successfully! 
        ...
        <form method="post" action="/GnD/emailcont/saveDailyEmail" enctype="multipart/form-data">
            <table border="0" width="80%">

                <tr>
                    <td>Email To:</td>
                    <td><input type="text" name="mailTo" size="65" value="${config.to}" required/></td>
                </tr>
                 <tr>
                    <td>CC:</td>
                    <td><input type="text" name="cc" size="65" value="${config.cc}" /></td>
                </tr>
                <tr>
                    <td>BCC:</td>
                    <td><input type="text" name="bcc" size="65" value="${config.bcc}" /></td>
                </tr>
                <tr>
                    <td>Subject:</td>
                    <td><input type="text" name="subject" size="65" value="${config.subject}" /></td>
                </tr>
                <tr>
                    <td>Message:</td>
                    <td><textarea cols="50" rows="10" name="message">${config.message}</textarea></td>
                </tr>
              	<tr>  
               		<td><input type="hidden" name="id" size="65" value="${config.id}"/></td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
                        <input type="submit" class="btn btn-blue top-margin padding-l" value="Save E-mail" />
                    </td>
                </tr>
            </table>
        </form>
