				...
				<div class="demo-left-nav" id="left-nav">
					<div class="navigation">
						...
						<c:if test='<%=request.isUserInRole("ROLE_RTO")||request.isUserInRole("ROLE_ADMIN")%>' >
										...
										<li id="prototype" class="selected"><a href="/GnD/shopfloor/rtoscanbyAWBtorto">RTO Scan By AWB</a></li>
										<li id="prototype"><a href="/GnD/shopfloor/rtochangeRTOAWB">Change RTO AWB</a></li>
