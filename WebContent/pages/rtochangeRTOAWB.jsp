...
<%-- 						 <li id="icons"><a href="<c:url value='/emailcont/editemailTable'/>">Email</a></li> --%>
					   ...
					   <c:if test='<%=request.isUserInRole("ROLE_RTO")||request.isUserInRole("ROLE_ADMIN")%>' >
						  <li id="prototype" class="selected" ><a href="/GnD/shopfloor/rto">RTO</a></li>
					  </c:if>
		...
		<div class="container main-conten">
				...
				<div class="demo-left-nav" id="left-nav">
					<div class="navigation">
						...
						<c:if test='<%=request.isUserInRole("ROLE_RTO")||request.isUserInRole("ROLE_ADMIN")%>' >
										...
										<li id="prototype"  ><a href="/GnD/shopfloor/rtoscanbyRSNtorto">RTO Scan by RSN</a></li>
										<li id="prototype"><a href="/GnD/shopfloor/rtoscanbyAWBtorto">RTO Scan By AWB</a></li>
										<li id="prototype" class="selected"><a href="/GnD/shopfloor/rtochangeRTOAWB">Change RTO AWB</a></li>
										<li id="prototype" ><a href=""></a></li>
			...
			<div class="right-content">
				...
				<h2 class="blue-text">Change AWB By Branch</h2>
					<form id="getList" name="getList" action="/GnD/shopfloor/rtogettxnbydate" method="post" onsubmit="return checkDates()">
