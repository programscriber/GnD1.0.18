				...
				<div class="demo-left-nav" id="left-nav">
					...
					<div class="navigation">
						<ul>
							...
							<li class="selected"><a href="/GnD/search/filesearch">File Search</a></li>
							<li><a href="/GnD/loginuser/recordsearch">Card/Pin Search</a></li>
						</ul>
					</div>
				</div>
			</div>
                        ...
                        <form action="/GnD/search/getFiles" method="post">
                            <div class="row right-con">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="select-menu select-menu-native select-menu-light">
                                        <input id="branch" type="text" class="text-field branch" name = "branch" />
