				 ...
				 <ul>
					  ...
					  <c:if test='<%=request.isUserInRole("ROLE_WAREHOUSE")||request.isUserInRole("ROLE_HELPDESK")||request.isUserInRole("ROLE_ADMIN")%>' >
					   ...
					   <c:if test='<%=request.isUserInRole("ROLE_SHOPFLOOR")||request.isUserInRole("ROLE_ADMIN")%>' >
						  <li id="prototype"  class="selected"><a href="/GnD/shopfloor/home" method='POST'>Shop floor</a></li>
					    </c:if>  
			...
			<div class="left-content">
				<div class="demo-left-nav" id="left-nav">
					<div class="navigation">
						<ul>
						<c:if test='<%=request.isUserInRole("ROLE_ADMIN")||request.isUserInRole("ROLE_SHOPFLOOR")%>' >
									...
									<c:if test='<%=request.isUserInRole("ROLE_ADMIN")||request.isUserInRole("ROLE_WAREHOUSE")%>' >
