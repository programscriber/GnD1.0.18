...
<!--                                         </div> -->
                        ...
                        <div class="col-md-12">
								<form action="/GnD/master/searchbranch" method="post" onsubmit="return validCheck()">
...
<!--                          		<td><input id="myBtn" type="button" value="edit" /><td> -->
    ...
    <tr>
    <th>Branch Id</th><td><input type="text" id="branchId" readonly="readonly"/></td>
    </tr>
    </tr>
    <tr>
...
<!-- 	<input type="text" id="namesubWinbank" /> -->
	...
	<center><input type="button" value="save"  class="btn btn-l btn-blue" onclick="return editBranch();"/>  <input type="button" value="delete"  class="btn btn-l btn-blue" onclick="return deleteBranch();"/></center>
  </div>
        ...
        function getLogin()
        {
     	  ...
     	  $.ajax({
    			...
    			$('#bankOption').html(bank);
    			 ...
    			 for(var x = 0; x < statusVa.length; x++){
    	        	...
    	        	$("#branchId").val(enumlist.branchId);	
         ...
         function deleteBranch(){
         	// alert($("#stateOption :selected").val());
        	  $.ajax({
        		  	method:"post",
      			url: "/GnD/master/deleteBranch?branchId="+$("#branchId").val(),
      			cache: false,				
      			success: function(data){
      				 alert(data);
      			},
        ...
        function formSubmit() {
            ...
            function hasLayout(el) {
                $(el).each(function (index, element) {
          		...
          		if(bankCode=="%%" && branchName=="%%" && branchCode=="%%"&& ifscCode=="%%") {
