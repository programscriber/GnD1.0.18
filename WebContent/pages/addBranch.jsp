...
<!--                                         </span> -->
                        ...
                        <div class="col-md-6">
                            	<div class="col-md-12">
                                    <span class="blue-text" >LHO Name</span>
                                    <div class="select-menu select-menu-native select-menu-light">
                                        <input id="lhoName" type="text" class="text-field " name="lhoName" required/>
<!--                                         <span class="addon"> -->
<!--                                             <span class="select-menu-icon"></span> -->
<!--                                         </span> -->
                                    </div>
...
<!--                                 <button id="submit" type="submit" class="btn btn-l">Save</button> -->
  ...
  <div class="modal-content">
	...
	<tr>
    <th>LHO Name</th><td><p id="namesubWinlhoName" ></p></td>
    </tr>
   ...
   <th>District</th>
	...
	<center><input type="button" class="btn btn-l btn-blue" value="save" onclick="return savedistrict();"/></center>
     ...
     function saveBranch(){
    	  $.ajax({
    		method:"post",
  			url: "/GnD/master/addBranchTo?branchshortcode="+$("#branchshortcodeid").val()+"&bank="+$("#bankName").val()+"&lcpcCode="+$("#lcpcCode").val()+"&address1="+$("#addressLine1").val()+"&addres3="+$("#addressLine3").val()+"&state="+$("#state").val()+"&pincode="+$("#pincode").val()+"&branchName="+$("#branchName").val()+"&status="+$("#status123").val()+"&lcpcbranch="+$("#lcpcbranch").val()+"&address2="+$("#addressLine2").val()+"&addres4="+$("#addressLine4").val()+"&district="+$("#district").val()+"&phone="+$("#phoneNum").val()+"&email="+$("#email").val()+"&isNonCardIssueBranch="+$("#isNonCardIssueBranchid").val()+"&lhoName="+$("#lhoName").val(),
  			cache: false,				
  			success: function(data){
  				 alert(data);
  			},
...
btn.onclick = function() {
	if(($("#branchshortcodeid").val()&&$("#bankName option:selected").text()&&$("#lcpcCode").val()&&$("#addressLine1").val()&&$("#addressLine3").val()&&$("#addressLine3").val()&&$("#addressLine4").val()&&$("#state option:selected").text()&&$("#pincode").val()&&$("#email").val()&&$("#branchName").val()&&$("#status123 option:selected").text()&&$("#lcpcbranch").val()&&$("#district option:selected").text()&&$("#phoneNum").val()&&$("#lhoName").val())==""){
	...
	$("#namesubWinlhoName").text($("#lhoName").val())
