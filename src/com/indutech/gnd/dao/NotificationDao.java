...
public class NotificationDao {
	...
	@Transactional
	public boolean saveDailyMailConfig(DailyNotification notify)
	{
		boolean result = true;
		try{
		Session sess =  getSessionFactory().getCurrentSession();
		  sess.saveOrUpdate(notify);
		}catch(Exception e){
			return false;
		}
	...
	@Transactional
	public List<DailyNotification> getDailyMailConfig()
	{
		List<DailyNotification> list=  getSessionFactory().getCurrentSession().createCriteria(DailyNotification.class).list();
		 return list; 
