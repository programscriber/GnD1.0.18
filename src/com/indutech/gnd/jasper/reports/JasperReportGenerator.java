...
//							sessionFactory.getCurrentSession());
			...
			String Date = todate.substring(3, 5);
			String Month = todate.substring(0, 2);
			String Year = todate.substring(6, 10);
			
			logger.info("//// : "+todate+","+Date+","+Month+","+Year);
...
/*cr 46 starts*/	
			...
			{
				if(reportName.equals("MIS_bankcodeGND") && reportName != null )
				{
					destFileName = destinationPath+"/"+bankName+"_"+reportName+"_"+QC+"."+fileType;
				}
				else
				{
					destFileName = destinationPath+"/"+reportName+"_"+date+"."+fileType;
...
/*cr 45 starts*/	
			...
			{					
				if(reportName != null && reportName.equals("core_file_summary"))
				{
					destFileName = destinationPath+"/"+bankName+"_"+reportName+"_"+QC+"."+fileType;
				}
				else
...
/* cr no 9 starts*/
	@Transactional
	public String generateReports(String fromdate, String todate, Long bankId) {
		String result = "Report Generated Successfully";
